...
$Dist::Zilla::Plugin::Test::Map::Tube::VERSION   = '0.08';
...
This test uses L<Test::Map::Tube> to check your map data and basic functions.When
L<Test::Map::Tube> v0.15 or above is installed then it can even test your routes.
...
Optionally you can also provide test routes in a plain text file as below:

    routes = path/to/routes.txt

The routes file should be structured as below:

    Route Name|Start Station Name|End Station Name|Start Station Name,via-station-name-1,via-station-name-2,End Station Name
    ....
    ....
    ....
...
# This file was automatically generated by Dist::Zilla::Plugin::Test::Map::Tube v%s.
...
plan skip_all => \"Test::Map::Tube %s required\" if \$\@;",
                               $Dist::Zilla::Plugin::Test::Map::Tube::VERSION, $min_ver, $min_tests, $min_ver);
